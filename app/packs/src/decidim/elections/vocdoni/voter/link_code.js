 ...
 *
 * The same table exists in `Decidim::Elections::Vocdoni::VotingPageUrl::API_HOSTS`, which
 * is what writes these links. The two are checked against each other by
 * `link_code.test.js` and `spec/services/decidim/elections/vocdoni/voting_page_url_spec.rb`,
...
export const API_HOSTS = {
  ...
  4: "https://saas-api-lts.vocdoni.net"
};
 ...
 * `Decidim::Elections::Vocdoni::VotingPageUrl`, which writes exactly this layout.
 *
