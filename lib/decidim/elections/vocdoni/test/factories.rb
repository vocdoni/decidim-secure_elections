...
unless FactoryBot::Internal.factories.registered?(:vocdoni_component)
  FactoryBot.define do
    ...
    factory :vocdoni_election, class: "Decidim::Elections::Vocdoni::Election" do
      transient do
        skip_injection { false }
      end
    ...
    factory :vocdoni_question, class: "Decidim::Elections::Vocdoni::Question" do
      transient do
        skip_injection { false }
        answers_count { 2 }
      end
    ...
    factory :vocdoni_answer, class: "Decidim::Elections::Vocdoni::Answer" do
      transient do
        skip_injection { false }
      end
    ...
    factory :vocdoni_census_member, class: "Decidim::Elections::Vocdoni::CensusMember" do
      transient do
        skip_injection { false }
      end
