...
# by spec/commands/decidim/elections/vocdoni/admin/update_election_questions_spec.rb.
describe "Admin Questions editor" do
  ...
  it "renders the .add-question button that DynamicFieldsComponent listens on" do
    expect(page).to have_button(I18n.t("decidim.elections.vocdoni.admin.questions.form.add_question"))
  end
